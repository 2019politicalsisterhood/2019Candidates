"""
Production settings for Political Sisterhood project.
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['politicalsisterhood.com', ])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='Political Sisterhood <noreply@politicalsisterhood.com>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[Political Sisterhood]')
